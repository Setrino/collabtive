<?php /* Smarty version Smarty-3.1.13, created on 2014-09-11 12:50:25
         compiled from "/Applications/MAMP/htdocs/collabtive/templates/standard/calbody_project.tpl" */ ?>
<?php /*%%SmartyHeaderCode:178500759654117e7116d8f2-83463063%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a20806dd06964b8de455e1b7b5ae3af4285330b6' => 
    array (
      0 => '/Applications/MAMP/htdocs/collabtive/templates/standard/calbody_project.tpl',
      1 => 1389140218,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178500759654117e7116d8f2-83463063',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54117e7151b8a1_83354241',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54117e7151b8a1_83354241')) {function content_54117e7151b8a1_83354241($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/Applications/MAMP/htdocs/collabtive/include/plugins/modifier.truncate.php';
?>
<table  id="timeline1" cellpadding="0" cellspacing="1" border="0" class="thecal"">
	...
	<thead class="calhead">
		<tr>
			<th><a class="scroll_left" href = "javascript:changeshow('manageproject.php?action=cal&id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
','thecal','progress');"></a></th>
 ...
 <?php echo $_smarty_tpl->tpl_vars['y']->value;?>
			...
			<th><a class="scroll_right" href = "javascript:changeshow('manageproject.php?action=cal&id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
...
.<?php echo $_smarty_tpl->tpl_vars['y']->value;?>
			...
			<li class="link"><a href="managetask.php?action=addform&id=<?php echo $_smarty_tpl->tpl_vars['project']->value['ID'];?>
...
"><?php echo $_smarty_tpl->tpl_vars['langfile']->value['addtask'];?>
			...
			<li class="link"><a href="managemilestone.php?action=addform&id=<?php echo $_smarty_tpl->tpl_vars['project']->value['ID'];?>
&theday=<?php echo $_smarty_tpl->tpl_vars['weeks']->value[$_smarty_tpl->getVariable('smarty')->value['section']['week']['index']][$_smarty_tpl->getVariable('smarty')->value['section']['day']['index']]['val'];?>
&themonth=<?php echo $_smarty_tpl->tpl_vars['m']->value;?>
&theyear=<?php echo $_smarty_tpl->tpl_vars['y']->value;?>
