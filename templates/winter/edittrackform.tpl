...
<h1 class="second"><img src="./templates/standard/images/symbols/timetracker.png" alt="" />{$track.username} ({$track.hours})</h1>
				...
				<h2>{#edittimetracker#}</h2>
					...
					<div class="row"><label for="day">{#startday#}:</label><input type="text" class="text" value="{$track.day}" name="day"  id="day" required="1" realname="day" /></div>
					<div class="datepick">
					...
					<div class="row"><label for="endday">{#endday#}:</label><input type="text" class="text" value="{$track.endday}" name="endday"  id="endday" required="1" realname="endday" /></div>
					<div class="datepick">
