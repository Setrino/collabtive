<table  id="timeline1" cellpadding="0" cellspacing="1" border="0" class="thecal">
	...
	<thead class="calhead">
		<tr>
			<th>
				<a class="scroll_left" href="javascript:changeshow('manageproject.php?action=cal&id={$id}&y={$py}&m={$pm}','thecal','progress');"></a>
			</th>
			...
			<th>
				<a class="scroll_right" href="javascript:changeshow('manageproject.php?action=cal&id={$id}&y={$ny}&m={$nm}','thecal','progress');"></a>
			</th>
		</tr>
		{* Days *}
		<tr class="dayhead">
					...
					{/if}
							...
							{if $weeks[week][day].currmonth == 1}
								<div id="t{$weeks[week][day].val}" class="calinmenue" style="display:none;" onclick="fadeToggle(this);">
									<ul>
										<li class="closewin">
											<a href="javascript:fadeToggle('t{$weeks[week][day].val}');">
												{$weeks[week][day].val}.{$m}.{$y}
											</a>
										</li>
										<li class="link">
											<a href="managetask.php?action=addform&id={$project.ID}&theday={$weeks[week][day].val}&themonth={$m}&theyear={$y}">
												{$langfile.addtask}
											</a>
										</li>
										<li class="link">
											<a href="managemilestone.php?action=addform&id={$project.ID}&theday={$weeks[week][day].val}&themonth={$m}&theyear={$y}">
												{$langfile.addmilestone}
											</a>
										</li>
									</ul>
								</div>
									...
									{if $weeks[week][day].milesnum > 0}
										...
										<div id="miles{$weeks[week][day].val}" style="display:none;">
											<div class="modaltitle">
												<img src="./templates/{$settings.template}/theme/{$settings.theme}/images/symbols/miles.png" alt="" />{$langfile.milestones} {$weeks[week][day].val}.{$m}.{$y}
															...
															{section name=stone loop=$weeks[week][day].milestones}
																...
																{/if}
																	...
																	<tr {if $weeks[week][day].milestones[stone].daysleft < 0} class="marker-late" {elseif $weeks[week][day].milestones[stone].daysleft == 0} class="marker-today" {/if} >
																		<td class="icon"><img src="./templates/{$settings.template}/theme/{$settings.theme}/images/symbols/miles.png" alt="" /></td>
																		<td>
																			<div class="toggle-in">
									...
									{if $weeks[week][day].tasksnum > 0}
										...
										<div id="tasks{$weeks[week][day].val}" style="display:none;">
											...
											<div class="modaltitle">
												...
												{$langfile.tasklist} {$weeks[week][day].val}.{$m}.{$y}
												<a class="winclose" href="javascript:Control.Modal.close();"></a>
											</div>
															...
															{section name=task loop=$weeks[week][day].tasks}
																...
																{/if}
																	...
																	<tr {if $weeks[week][day].tasks[task].daysleft < 0} class="marker-late" {elseif $weeks[week][day].tasks[task].daysleft == 0} class="marker-today" {/if} >
																		<td class="icon"><img src="./templates/{$settings.template}/theme/{$settings.theme}/images/symbols/task.png" alt="" /></td>
																		<td>
																			<div class="toggle-in">
