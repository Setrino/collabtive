...
<div class="block_in_wrapper">
	...
	<form novalidate class="main" method="post" action="managecustomer.php?action=edit&amp;id={$customer.ID}" {literal}onsubmit="return validateCompleteForm(this,'input_error');"{/literal}>
		<fieldset>
